# English Conversion Audit Report - nan-ai-engineering-labs
...
| examples/ex_01_vector_dot_product_baseline.py | Python | English |

| examples/ex_02_descriptive_statistics_baseline.py | Python | English |

| examples/ex_03_feature_scaling_normalization.py | Python | English |

| examples/ex_04_linear_regression_from_scratch.py | Python | English |

| examples/ex_05_gradient_descent_one_parameter.py | Python | English |
...
| examples/ex_01_dataset_profiling_baseline.py | Python | English |

| examples/ex_02_missing_values_imputation.py | Python | English |

| examples/ex_03_outlier_detection_iqr.py | Python | English |

| examples/ex_04_business_visualization_ascii.py | Python | English |

| examples/ex_05_data_quality_rules_check.py | Python | English |

| examples/ex_06_reproducible_cleaning_pipeline.py | Python | English |

| mini-project/README.md | Markdown | Spanish |

| notes/README.md | Markdown | English |

| practices/01-limpieza-datos-exploracion.md | Markdown | Spanish |

| practices/02-visualizacion-avanzada.md | Markdown | Spanish |

| practices/README.md | Markdown | Mixed |

| practices/practice-01-ingesta-y-perfilado.md | Markdown | Spanish |

| practices/practice-02-limpieza-de-nulos-y-duplicados.md | Markdown | Spanish |

| practices/practice-03-normalizacion-y-tipos.md | Markdown | Spanish |
...
| examples/ex_01_train_test_split_baseline.py | Python | English |

| examples/ex_02_linear_vs_logistic_baseline.py | Python | English |

| examples/ex_03_regularization_tradeoffs.py | Python | English |

| examples/ex_04_tree_depth_vs_overfitting.py | Python | English |

| examples/ex_05_model_comparison_metrics.py | Python | English |

| examples/ex_06_reproducible_ml_pipeline.py | Python | English |
...
| practices/practice-01-baseline-regresion.md | Markdown | Spanish |

| practices/practice-02-clasificacion-binaria.md | Markdown | Spanish |
...
| examples/ex_01_neuron_forward_baseline.py | Python | English |

| examples/ex_02_gradient_descent_baseline.py | Python | English |

| examples/ex_03_activation_functions_comparison.py | Python | English |

| examples/ex_04_overfitting_regularization_simulation.py | Python | English |

| examples/ex_05_simple_mlp_from_scratch.py | Python | English |

| examples/ex_06_reproducible_training_loop.py | Python | English |

| mini-project/README.md | Markdown | Spanish |

| notes/README.md | Markdown | English |

| practices/01-redes-neuronales-pytorch.md | Markdown | Mixed |

| practices/02-cnns-transfer-learning.md | Markdown | Mixed |

| practices/README.md | Markdown | English |

| practices/practice-01-neurona-y-forward-pass.md | Markdown | Spanish |

| practices/practice-02-red-mlp-basica.md | Markdown | Spanish |
...
| examples/ex_01_text_preprocessing_baseline.py | Python | Mixed |

| examples/ex_02_embeddings_similarity_baseline.py | Python | English |

| examples/ex_03_prompt_variants_quality.py | Python | Mixed |

| examples/ex_04_chunking_strategies_rag.py | Python | English |

| examples/ex_05_rag_minimal_eval.py | Python | Mixed |

| examples/ex_06_llm_workflow_with_guardrails.py | Python | English |
...
| practices/practice-01-limpieza-tokenizacion.md | Markdown | Spanish |

| practices/practice-02-tfidf-clasificacion.md | Markdown | Spanish |

| practices/practice-03-embeddings-similitud.md | Markdown | Spanish |

| practices/practice-04-prompting-basico.md | Markdown | Spanish |

| practices/practice-05-evaluacion-llm.md | Markdown | Spanish |
...
| examples/ex_01_image_matrix_basics.py | Python | English |

| examples/ex_02_convolution_baseline.py | Python | English |

| examples/ex_03_edge_detection_filter.py | Python | English |

| examples/ex_04_iou_metric_demo.py | Python | English |

| examples/ex_05_object_detection_nms_demo.py | Python | English |

| examples/ex_06_cv_pipeline_reproducible.py | Python | English |
...
| practices/practice-01-imagenes-y-canales.md | Markdown | Spanish |

| practices/practice-02-preprocesamiento-base.md | Markdown | Spanish |
...
| examples/ex_01_time_series_visualization_baseline.py | Python | English |

| examples/ex_02_naive_vs_moving_average_forecast.py | Python | English |

| examples/ex_03_seasonal_baseline_forecast.py | Python | English |

| examples/ex_04_zscore_anomaly_detection.py | Python | English |

| examples/ex_05_residual_anomaly_detection.py | Python | English |

| examples/ex_06_reproducible_timeseries_pipeline.py | Python | English |
...
| examples/01-collaborative-filtering.md | Markdown | Spanish |

| examples/02-matrix-factorization-svd.md | Markdown | Spanish |

| examples/README.md | Markdown | English |

| examples/ex_01_popularity_baseline_recommender.py | Python | English |

| examples/ex_02_item_similarity_recommender.py | Python | English |

| examples/ex_03_user_similarity_recommender.py | Python | English |

| examples/ex_04_precision_recall_at_k.py | Python | English |

| examples/ex_05_cold_start_fallbacks.py | Python | English |

| examples/ex_06_reproducible_recommender_pipeline.py | Python | English |

| mini-project/README.md | Markdown | Spanish |

| notes/README.md | Markdown | Mixed |

| practices/01-collaborative-filtering.md | Markdown | Spanish |

| practices/02-content-based-hybrid.md | Markdown | Spanish |

| practices/README.md | Markdown | English |

| practices/practice-01-baseline-popularidad.md | Markdown | Spanish |

| practices/practice-02-item-based-cf.md | Markdown | Spanish |

| practices/practice-03-user-based-cf.md | Markdown | Spanish |

| practices/practice-04-evaluacion-ranking.md | Markdown | Spanish |

| practices/practice-05-cold-start-y-mejora.md | Markdown | Spanish |
...
| examples/ex_01_prompt_baseline_quality.py | Python | English |

| examples/ex_02_structured_prompt_constraints.py | Python | English |

| examples/ex_03_prompt_iteration_feedback_loop.py | Python | English |

| examples/ex_04_guardrails_input_output.py | Python | English |

| examples/ex_05_rag_prompt_pipeline_demo.py | Python | English |

| examples/ex_06_reproducible_prompt_evaluation.py | Python | English |

| mini-project/README.md | Markdown | Spanish |

| notes/README.md | Markdown | Mixed |

| practices/01-gans.md | Markdown | Spanish |

| practices/02-vae-diffusion.md | Markdown | Spanish |

| practices/README.md | Markdown | English |

| practices/practice-01-prompt-base.md | Markdown | Spanish |

| practices/practice-02-few-shot-y-formato.md | Markdown | Spanish |

| practices/practice-03-iteracion-y-mejora.md | Markdown | Spanish |

| practices/practice-04-guardrails-basicos.md | Markdown | Spanish |

| practices/practice-05-evaluacion-de-respuestas.md | Markdown | Spanish |
...
| examples/ex_01_group_distribution_bias_check.py | Python | English |

| examples/ex_02_demographic_parity_metric.py | Python | English |

| examples/ex_03_counterfactual_fairness_check.py | Python | English |

| examples/ex_04_local_explanation_feature_contributions.py | Python | English |

| examples/ex_05_risk_report_generator.py | Python | English |

| examples/ex_06_reproducible_ethics_audit_pipeline.py | Python | English |
...
| examples/ex_01_data_classification_matrix.py | Python | English |

| examples/ex_02_basic_masking_pseudonymization.py | Python | English |

| examples/ex_03_access_control_matrix.py | Python | English |

| examples/ex_04_pipeline_security_checklist.py | Python | English |

| examples/ex_05_prompt_injection_risk_demo.py | Python | English |

| examples/ex_06_reproducible_privacy_audit_pipeline.py | Python | English |
...
| practices/practice-01-clasificacion-de-datos.md | Markdown | Spanish |
...
| examples/ex_01_reproducible_pipeline_manifest.py | Python | English |

| examples/ex_02_batch_vs_realtime_serving.py | Python | English |

| examples/ex_03_latency_monitoring_baseline.py | Python | English |

| examples/ex_04_drift_detection_demo.py | Python | English |

| examples/ex_05_canary_rollout_decision.py | Python | English |

| examples/ex_06_reproducible_mlops_runbook.py | Python | English |

| mini-project/README.md | Markdown | Spanish |

| notes/README.md | Markdown | English |

| practices/01-cicd-ml.md | Markdown | Spanish |

| practices/02-monitoring-observability.md | Markdown | Spanish |
...
| 02-data-collection-cleaning-visualization | practices/01-limpieza-datos-exploracion.md | Spanish |

| 02-data-collection-cleaning-visualization | practices/02-visualizacion-avanzada.md | Spanish |

| 02-data-collection-cleaning-visualization | practices/README.md | Mixed |

| 02-data-collection-cleaning-visualization | practices/practice-01-ingesta-y-perfilado.md | Spanish |

| 02-data-collection-cleaning-visualization | practices/practice-02-limpieza-de-nulos-y-duplicados.md | Spanish |

| 02-data-collection-cleaning-visualization | practices/practice-03-normalizacion-y-tipos.md | Spanish |
...
| 03-machine-learning-fundamentals | practices/practice-01-baseline-regresion.md | Spanish |

| 03-machine-learning-fundamentals | practices/practice-02-clasificacion-binaria.md | Spanish |
...
| 04-deep-learning-basics | practices/01-redes-neuronales-pytorch.md | Mixed |

| 04-deep-learning-basics | practices/02-cnns-transfer-learning.md | Mixed |

| 04-deep-learning-basics | practices/practice-01-neurona-y-forward-pass.md | Spanish |

| 04-deep-learning-basics | practices/practice-02-red-mlp-basica.md | Spanish |
...
| 05-nlp-large-language-models | examples/ex_01_text_preprocessing_baseline.py | Mixed |

| 05-nlp-large-language-models | examples/ex_03_prompt_variants_quality.py | Mixed |

| 05-nlp-large-language-models | examples/ex_05_rag_minimal_eval.py | Mixed |

| 05-nlp-large-language-models | mini-project/README.md | Spanish |
...
| 05-nlp-large-language-models | practices/practice-01-limpieza-tokenizacion.md | Spanish |

| 05-nlp-large-language-models | practices/practice-02-tfidf-clasificacion.md | Spanish |

| 05-nlp-large-language-models | practices/practice-03-embeddings-similitud.md | Spanish |

| 05-nlp-large-language-models | practices/practice-04-prompting-basico.md | Spanish |

| 05-nlp-large-language-models | practices/practice-05-evaluacion-llm.md | Spanish |
...
| 06-computer-vision | mini-project/README.md | Spanish |
...
| 06-computer-vision | practices/practice-01-imagenes-y-canales.md | Spanish |

| 06-computer-vision | practices/practice-02-preprocesamiento-base.md | Spanish |
...
| 07-time-series-anomaly-detection | notes/README.md | Mixed |
...
| 08-recommender-systems | examples/01-collaborative-filtering.md | Spanish |

| 08-recommender-systems | examples/02-matrix-factorization-svd.md | Spanish |

| 08-recommender-systems | mini-project/README.md | Spanish |

| 08-recommender-systems | notes/README.md | Mixed |

| 08-recommender-systems | practices/01-collaborative-filtering.md | Spanish |

| 08-recommender-systems | practices/02-content-based-hybrid.md | Spanish |

| 08-recommender-systems | practices/practice-01-baseline-popularidad.md | Spanish |

| 08-recommender-systems | practices/practice-02-item-based-cf.md | Spanish |

| 08-recommender-systems | practices/practice-03-user-based-cf.md | Spanish |

| 08-recommender-systems | practices/practice-04-evaluacion-ranking.md | Spanish |

| 08-recommender-systems | practices/practice-05-cold-start-y-mejora.md | Spanish |
...
| 09-generative-ai-prompt-engineering | notes/README.md | Mixed |

| 09-generative-ai-prompt-engineering | practices/01-gans.md | Spanish |

| 09-generative-ai-prompt-engineering | practices/02-vae-diffusion.md | Spanish |

| 09-generative-ai-prompt-engineering | practices/practice-01-prompt-base.md | Spanish |

| 09-generative-ai-prompt-engineering | practices/practice-02-few-shot-y-formato.md | Spanish |

| 09-generative-ai-prompt-engineering | practices/practice-03-iteracion-y-mejora.md | Spanish |

| 09-generative-ai-prompt-engineering | practices/practice-04-guardrails-basicos.md | Spanish |

| 09-generative-ai-prompt-engineering | practices/practice-05-evaluacion-de-respuestas.md | Spanish |
...
| 10-ethics-bias-explainability | mini-project/README.md | Spanish |
...
| 11-data-privacy-security | practices/practice-01-clasificacion-de-datos.md | Spanish |
...
| 12-mlops-ai-in-production | practices/01-cicd-ml.md | Spanish |

| 12-mlops-ai-in-production | practices/02-monitoring-observability.md | Spanish |
